...
//             style={{ height: "100%" }}
//           >
//             <div className="flex flex-col justify-start items-center w-full h-5 overflow-hidden px-7">
//               <div className="flex flex-col justify-center items-center h-fit py-1 text-[13px] text-top uppercase leading-[100%] tracking-widest">
//                 <span>{buttonText}</span>
//               </div>
//               <div className="text-bottom flex flex-col justify-center items-center h-fit py-1 text-[13px] uppercase leading-[100%] tracking-widest">
//                 <span>{buttonText}</span>
//               </div>
//             </div>
//           </div>
