        ...
        <>
            ...
            >
                <img
                    ...
                    src={image}
                    alt={title}
                    className="z-0 absolute w-full h-full object-cover origin-center select-none"
                    style={{
                        scale: 1.5,
                ...
                <div id={`content-${index}`} className="z-10 absolute inset-0 flex flex-row justify-between p-16 font-family-neue text-white">
                    {/* Left section */}
